...
1. IT System Administrator Herne Hill/Mr. X Media, Toronto (Oct 2025–Jan 2026, Contract)
...
SKILLS: AWS, Azure, GCP, OCI, Linux, Windows Server, Active Directory, M365, Intune, SCCM, Terraform, Kubernetes, Docker, Load Balancing, NAS / SAN, CI/CD Pipelines, GitHub Actions, PowerShell, Bash, Python, Ansible, n8n Automation, Zero Trust, Cybersecurity, Endpoint Security, SIEM, Gitleaks, ITIL, Cloud Migration, Vercel, AI Integration, MLOps, Generative AI, AI Solutions Architecture, Power BI, REST APIs, Supabase RLS, RBAC/MFA, MySQL, PostgreSQL, Salesforce, QuickBase, HTML, PHP, WordPress, FortiGate, Palo Alto firewalls
