...
SKILLS: AWS, Azure, GCP, OCI, Linux, Windows Server, Active Directory, M365, Intune, Windows Autopilot, Configuration Manager (SCCM/MECM, architectural and conceptual), Terraform, Kubernetes, Docker, Load Balancing, NAS / SAN, CI/CD Pipelines, GitHub Actions, PowerShell, Bash, Python, Ansible, n8n Automation, Zero Trust, Cybersecurity, Endpoint Security, SIEM, Gitleaks, ITIL, Cloud Migration, Vercel, AI Integration, MLOps, Generative AI, AI Solutions Architecture, Power BI, REST APIs, Supabase RLS, RBAC/MFA, MySQL, PostgreSQL, Salesforce, QuickBase, HTML, PHP, WordPress, FortiGate, Palo Alto firewalls

ANSWERING PRECISELY (do not overstate these):
Microsoft Configuration Manager (SCCM/MECM): the answer to "does he know SCCM" is YES, qualified by depth. His Configuration Manager knowledge is architectural and conceptual, from MD-102 Endpoint Administrator training covering SCCM, collections, deployments, and co-management, plus lab practice. His production endpoint depth is on the Intune side: he took device compliance from 60% to 90% at AMI and ran a hybrid-join Autopilot pilot in the production tenant. Never claim he has operated a Configuration Manager console in production or built images with it.
