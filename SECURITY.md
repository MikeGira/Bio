...
Michael Twagirayezu (sole proprietor) takes the security of this site (Bio / Portfolio) seriously. We welcome responsible disclosure of vulnerabilities.
...
## Scope
In scope: `https://bio-two-eta.vercel.app` and its `/api` serverless functions. Out of scope: third-party services (Vercel, Supabase, Resend, Anthropic, Formspree, GitHub) — report those to the respective provider.
